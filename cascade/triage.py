...
- Sonst (Begrüssung, Smalltalk, Frage zu dir/Status, generelle Diskussion,
  Klärungsfrage, Dank, etc.):
...
SYSTEM_EN = """You are the dispatcher of a coding bot called Claude-Cascade.
...
- Otherwise (greeting, smalltalk, question about you/status, general
  discussion, clarification, thanks, …):
...
async def triage(message: str, *, lang: str = "de", s: Settings | None = None) -> TriageResult:
    s = s or settings()
