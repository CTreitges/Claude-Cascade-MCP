...
__all__ = [
    ...
    "cmd_help", "cmd_start", "cmd_whoami", "cmd_settings",
    "cmd_forget", "cmd_chat", "cmd_errors", "cmd_unknown",
    ...
    "cmd_iterations", "cmd_failsbeforereplan", "cmd_subtasks", "cmd_toggles",
    "on_iterations_callback", "on_failsbeforereplan_callback",
    "on_subtasks_callback", "on_toggles_callback",
